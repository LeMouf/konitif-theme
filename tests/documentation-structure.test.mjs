...
test('consumer README follows the public documentation contract', () => {
  ...
  assert.doesNotMatch(readme, /AGENTS\.md|npm ci|npm run (?:test|typecheck|verify)|NPM_PUBLISH_ENABLED|Trusted Publish|release authority|public distribution candidate/i);
